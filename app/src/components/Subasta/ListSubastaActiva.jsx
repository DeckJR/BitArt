...
import { ListCardSubastaActiva } from "./ListCardSubastaActiva";


export function ListSubastaActiva() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await SubastaService.getAllSubastaActiva();
    ...
    return (    
        ...
        <ListCardSubastaActiva data={data.data} isActive />
        </div>
    );
}
