...
import { ListCardSubastaFinalizada } from "./ListCardSubastaFinalizada";


export function ListSubastafinalizada() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await SubastaService.getAllSubastaFinalizada();
    ...
    return (    
        ...
        <ListCardSubastaFinalizada data={data.data} isInactive />
        </div>
    );
}
